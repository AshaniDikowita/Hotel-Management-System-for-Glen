...
public class Hr_Manager extends javax.swing.JFrame {
    ...
    public Hr_Manager() {
        ...
        userlogsPanel.setVisible(false);
    ...
    {
        try {
            String Sql="select E.employee_id AS 'Employee ID', CONCAT(E.employee_fname, ' ', E.employee_lname)AS 'FullName',E.employee_basic_salary AS 'Basic Salary' from hr_employee E WHERE E.employee_type='Permanent Employee'";
            pstatement = conn.prepareStatement(Sql);
            Results=pstatement.executeQuery();
    ...
    {
        try {
            String Sql="select E.employee_id AS 'Employee ID', CONCAT(E.employee_fname, ' ', E.employee_lname)AS 'FullName',E.employee_hourly_rate AS 'Hourly Rate'from hr_employee E WHERE E.employee_type='Part Time Employee'";
            pstatement = conn.prepareStatement(Sql);
            Results=pstatement.executeQuery();
    ...
    private void initComponents() {
        ...
        jLabelglenLogo = new javax.swing.JLabel();
        ...
        AddEmployeeDemojButton2 = new javax.swing.JButton();
        ...
        jButtonlogout.setBounds(930, 30, 80, 23);

        welcomeuser.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        welcomeuser.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        headerPanel.add(welcomeuser);
        welcomeuser.setBounds(930, 10, 80, 20);

        welcomeuser1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        welcomeuser1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        welcomeuser1.setText("Welcome");
        welcomeuser1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        headerPanel.add(welcomeuser1);
        welcomeuser1.setBounds(850, 10, 70, 20);
        headerPanel.add(jLabelglenLogo);
        jLabelglenLogo.setBounds(20, 10, 0, 0);

        jLabelheaderimage.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 153, 255)));
        headerPanel.add(jLabelheaderimage);
        jLabelheaderimage.setBounds(0, 0, 1024, 130);

        HRManagerPanel.add(headerPanel);
        headerPanel.setBounds(0, 0, 1024, 130);
        ...
        buttonfinanceUserlogs.setBackground(new java.awt.Color(51, 153, 255));
        ...
        buttonfinanceUserlogs.setBorder(null);
        ...
        buttonfinanceSettings.setBackground(new java.awt.Color(51, 153, 255));
        ...
        buttonfinanceSettings.setBorder(null);
        ...
        mainButtonPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainButtonPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainButtonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(buttonfinanceUserlogs, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
        ...
        AddEmployeeDemojButton2.setBackground(new java.awt.Color(204, 204, 204));
        AddEmployeeDemojButton2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        AddEmployeeDemojButton2.setText("DEMO");
        AddEmployeeDemojButton2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 255)));
        AddEmployeeDemojButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AddEmployeeDemojButton2ActionPerformed(evt);
            }
        });
            ...
            .addGroup(personalDetailsjPanel1Layout.createSequentialGroup()
                .addGroup(personalDetailsjPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(personalDetailsjPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(50, 50, 50)
                        .addComponent(employeefirstnamejTextField1, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(61, 61, 61)
                    ...
                    .addGroup(personalDetailsjPanel1Layout.createSequentialGroup()
                        .addGap(457, 457, 457)
                        .addComponent(AddEmployeeDemojButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        personalDetailsjPanel1Layout.setVerticalGroup(
            ...
            .addGroup(personalDetailsjPanel1Layout.createSequentialGroup()
                ...
                .addGroup(personalDetailsjPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(AddEmployeeDemojButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
        ...
        depatrmentjComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select the Department", "HR Department", "Finance Department", "Stock Mangement Department", "Room Mangement Department", "Event Management Department", "Transport Department", "Restaurant" }));
        ...
        serachEmployeeFnamejLabel.setText("Employee First Name");
        ...
        leavesEmloyeeFirstNamejLabel2.setText("Full Name");
        ...
        emplyeeLeavesjserachTabbedPane1.addTab("Leave confirmation", jPanel2);
        ...
        userlogsPanel.setPreferredSize(new java.awt.Dimension(830, 550));
        ...
        javax.swing.GroupLayout financeSettingsPanelLayout = new javax.swing.GroupLayout(financeSettingsPanel);
        financeSettingsPanel.setLayout(financeSettingsPanelLayout);
        financeSettingsPanelLayout.setHorizontalGroup(
            financeSettingsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 830, Short.MAX_VALUE)
        );
        financeSettingsPanelLayout.setVerticalGroup(
            financeSettingsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 550, Short.MAX_VALUE)
        );
    ...
    private void buttonfinanceUserlogsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonfinanceUserlogsActionPerformed
        // TODO add your handling code here:
        panelshift(buttonfinanceUserlogs.getText());
    ...
    private void buttonfinanceSettingsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonfinanceSettingsActionPerformed
        // TODO add your handling code here:
        panelshift(buttonfinanceSettings.getText());
    }//GEN-LAST:event_buttonfinanceSettingsActionPerformed

    private void jButtonlogoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonlogoutActionPerformed
        // TODO add your handling code here:
        int result=JOptionPane.showConfirmDialog(HRManagerPanel,"Do you want to Log Out from the system?","Logout Confirmation",0);
        
        if(result==0){
            jDesktopPaneFinance.setVisible(false);
        }
    ...
    private void buttonfinanceUserlogsMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonfinanceUserlogsMouseExited
        // TODO add your handling code here:
        buttonfinanceUserlogs.setBackground(new Color(51,153,255));
    ...
    private void buttonfinanceSettingsMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonfinanceSettingsMouseExited
        // TODO add your handling code here:
        buttonfinanceSettings.setBackground(new Color(51,153,255));
    ...
    private void employeeSearchjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_employeeSearchjButton1ActionPerformed
       ...
       else if(!searchFname.matches("^[a-zA-Z\\s]*$")){
           JOptionPane.showMessageDialog(searchEmployeejPanel2, "Please Enter Valid employee Name.", "Invalid Name!", 0);
            ...
            try {
                ...
                String Sql="select employee_id AS 'Employee ID', CONCAT(employee_fname, ' ', employee_lname)AS 'FullName',employee_nic AS 'NIC',employee_telephone AS 'Telephone',employee_address AS 'Address',employee_sex AS 'Gender',employee_DOB AS 'Date of Birth',employee_designation AS 'Designation',employee_type AS 'Type OF Employee',employee_hourly_rate AS 'Hourly Rate',employee_basic_salary AS 'Basic Salary',employee_department AS 'Department' from hr_employee where employee_fname LIKE '%"+ searchFname +"%'";
                pstatement = conn.prepareStatement(Sql);
                Results=pstatement.executeQuery();
                searchjTable6.setModel(DbUtils.resultSetToTableModel(Results));
    ...
    private void saveEmployeejButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveEmployeejButton1ActionPerformed
           ...
           updateHourlyRate=editHourlyRatejTextField3.getText();
            ...
            temp = upadteFName.split(delimiter);   
             fName = temp[0];   
             Lname = temp[1];
             
             if(!fName.matches("^[a-zA-Z\\s]*$"))
                 JOptionPane.showMessageDialog(editEmployeejPanel1, "Please Enter Valid employee Name.", "Invalid First Name!", 0);
             
             else if(!Lname.matches("^[a-zA-Z\\s]*$"))
                 JOptionPane.showMessageDialog(editEmployeejPanel1, "Please Enter Valid employee Name.", "Invalid Last Name!", 0);
             
             else if(!updateAddress.matches("^[a-zA-Z\\s]*$"))
                 JOptionPane.showMessageDialog(editEmployeejPanel1, "Please Enter Valid employee Address.", "Invalid Address!", 0);
             
             else if(!updateDesignation.matches("^[a-zA-Z\\s]*$"))
                  JOptionPane.showMessageDialog(editEmployeejPanel1, "Please Enter employee Designation correctly.", "Invalid Designation!", 0);
             
             else if(!UpdateTep.matches("^[0-9]*$")||UpdateTep.length() != 10)
                 JOptionPane.showMessageDialog(editEmployeejPanel1, "Please Enter Valid Number.", "Invalid Telephone Number!", 0);
                 
             else if(!(updateNIC.length() == 10) && (!updateNIC.matches("^[0-9]{9}[vVxX]$"))) 
              JOptionPane.showMessageDialog(editEmployeejPanel1, "Please Enter Valid employee NIC.", "Invalid NIC!", 0);
            
             else if(!updateBasicSalary.matches("^[0-9]*$"))
                  JOptionPane.showMessageDialog(editEmployeejPanel1, "Please Enter Valid Basic Salary.", "Invalid Basic Salary!", 0);
        
             else if(!updateHourlyRate.matches("^[0-9]*$"))
                 JOptionPane.showMessageDialog(editEmployeejPanel1, "Please Enter Valid Hourly Rate.", "Invalid Hourly Rate!", 0);
            
             else{
                            try {

                                String sql="UPDATE hr_employee SET employee_fname='"+fName+"',employee_lname='"+Lname+"',employee_nic='"+updateNIC+"',employee_address='"+updateAddress+"',employee_designation='"+updateDesignation+"',employee_type='"+updateTypeOfEmployee+"',employee_telephone='"+UpdateTep+"',employee_department='"+updateDepartment+"',employee_basic_salary='"+ updateBasicSalary+"',employee_hourly_rate='"+updateHourlyRate+"' WHERE employee_id='"+empID+"'";
                                pstatement=conn.prepareStatement(sql);
                                pstatement.execute();
    ...
    private void AddEmployeeNextjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddEmployeeNextjButton1ActionPerformed
       ...
       if(addEmployeeSexMalejRadioButton1.isSelected()){
        ...
        try {
            ...
            edob = dateFormat.format(addEmployeeDOBjDateChooser1.getDate());
            hasParseError=false;
         ...
         if(hasParseError==true)
            datePickerPanal.setBackground(new Color(255, 150, 150));
         else
             datePickerPanal.setBackground(new Color(255, 255, 255));
        ...
        if(eSex.matches(""))
        {
            addEmployeeSexMalejRadioButton1.setBackground(new Color(255, 150, 150));
            addEmployeeSexFemalejRadioButton2.setBackground(new Color(255, 150, 150));
        }
        else
        {
            addEmployeeSexMalejRadioButton1.setBackground(new Color(255, 255, 255));
            addEmployeeSexFemalejRadioButton2.setBackground(new Color(255, 255, 255));
        }  
        if( eTep.isEmpty())
        ...
        if(typeOfEmployeejComboBox1.getSelectedItem()=="Select the type")
            ...
            typeOfEmployeejComboBox1.setBackground(new Color(255, 255, 255));
                   
        
        
        if(eFname.isEmpty() || eLname.isEmpty() || eNic.isEmpty() || eAdd.isEmpty() || edesignation.isEmpty() || eTep.isEmpty() || eSex.matches("")|| edesignation.isEmpty()||edob.isEmpty()||typeOfEmployeejComboBox1.getSelectedItem()=="Select the type"||hasParseError){
            JOptionPane.showMessageDialog(personalDetailsjPanel1, "Please fill all the fields to continue.", "Form Incomplete!", 0);
          
    }//GEN-LAST:event_AddEmployeeNextjButton1ActionPerformed
        else if(!eFname.matches("^[a-zA-Z\\s]*$")){
            JOptionPane.showMessageDialog(personalDetailsjPanel1, "Please Enter Valid employee first Name.", "Invalid Name!", 0);
        }
        else if(!eLname.matches("^[a-zA-Z\\s]*$")){
             JOptionPane.showMessageDialog(personalDetailsjPanel1, "Please Enter Valid employee last Name.", "Invalid Name!", 0);
        }
        else if(!(eNic.length() == 10) && (!eNic.matches("^[0-9]{9}[vVxX]$"))) {
             JOptionPane.showMessageDialog(personalDetailsjPanel1, "Please Enter Valid employee NIC.", "Invalid NIC!", 0);
              
        }
        else if(!eTep.matches("^[0-9]*$")||eTep.length() != 10){
            JOptionPane.showMessageDialog(personalDetailsjPanel1, "Please Enter Valid Telphone number", "Invalid Telephone Number!", 0);
            
        }
        else if(!edesignation.matches("^[a-zA-Z\\s]*$"))
        {
            JOptionPane.showMessageDialog(personalDetailsjPanel1, "Please Enter Valid Designation", "Invalid Designation!", 0);
        }
    ...
    private void addEmployeeAddjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addEmployeeAddjButton1ActionPerformed
        ...
        if(!eBasicSalry.matches("^[0-9]*$")){
            JOptionPane.showMessageDialog(personalDetailsjPanel1, "Please enter basic salary correctly  .", "Invalid basic salary!", 0);
                  
        }
               
        else if(!eHourlyRate.matches("^[0-9]*$"))
        {
            JOptionPane.showMessageDialog(personalDetailsjPanel1, "Please enter hourly rate correctly  .", "Invalid hourly rate!", 0);
        }
    ...
    private void salaryCalculatejButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salaryCalculatejButtonActionPerformed
        ...
        else if(!otherPay.matches("^[0-9]*$"))
                JOptionPane.showMessageDialog(salaryjPanel1, "Please check other pay value.", "Invalid Value!", 0);
        
        else if(!deduc.matches("^[0-9]*$"))
            JOptionPane.showMessageDialog(salaryjPanel1, "Please check other deduction value.", "Invalid Value!", 0);
    ...
    private void wageCalculatejButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_wageCalculatejButton1ActionPerformed
     ...
     else if(!wageWorkedHours.matches(("^[0-9]*$")))
        JOptionPane.showMessageDialog(salaryjPanel1, "Please check worked hour value.", "Invalid Value!", 0);
     
     else if(!wagededuc.matches("^[0-9]*$"))
         JOptionPane.showMessageDialog(salaryjPanel1, "Please check deduction value.", "Invalid Value!", 0);
     
     else if(!wageOtherpay.matches("^[0-9]*$"))
         JOptionPane.showMessageDialog(salaryjPanel1, "Please check other pay value.", "Invalid Value!", 0);
    ...
    private void leaveEmployeeSearchjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_leaveEmployeeSearchjButtonActionPerformed
      ...
      if(leavesFullName.isEmpty())
        JOptionPane.showMessageDialog(jPanel1, "Please fill name fields to continue.", "Form Incomplete!", 0);
      else if(!leavesFullName.matches(("^[a-zA-Z\\s]*$")))
           JOptionPane.showMessageDialog(salaryjPanel1, "Please check Employee name.", "Invalid Employee Name!", 0);
      else{
      
          try {
              String Sql="select employee_id AS 'Employee ID', CONCAT(employee_fname, ' ', employee_lname)AS 'FullName'From hr_employee where employee_fname LIKE '%"+ leavesFullName +"%'";
              pstatement = conn.prepareStatement(Sql);
              Results=pstatement.executeQuery();
              leavesEmplyeejTable4.setModel(DbUtils.resultSetToTableModel(Results));
          } catch (Exception e) {
    ...
    private void AddEmployeeDemojButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddEmployeeDemojButton2ActionPerformed
        // TODO add your handling code here:
        employeefirstnamejTextField1.setText("Ranith");
        employeeLNamejTextField2.setText("Dinuka");
        employeeNicjTextField2.setText("950701510V");
        employeeTpjTextField3.setText("0752837611");
        employeeAddjTextField2.setText("Colombo");
        adEemployeeDesignationjTextField2.setText("HR Manager");
        typeOfEmployeejComboBox1.setSelectedItem("Permanent Employee");
        depatrmentjComboBox1.setSelectedItem("Room Mangement Department");
        basicSalaryjTextField2.setText("80000");
        
       
       
        
    }//GEN-LAST:event_AddEmployeeDemojButton2ActionPerformed
    ...
    javax.swing.JButton AddEmployeeDemojButton2;
    ...
    javax.swing.JLabel jLabelglenLogo;
    ...
    javax.swing.JPanel userlogsPanel;
